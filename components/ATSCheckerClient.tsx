...
import { ShieldAlert, XCircle, Search, ShieldCheck, UploadCloud, FileText, Loader2, CheckCircle2, RefreshCw, HelpCircle, CheckCircle } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="mt-16 bg-white p-8 rounded-2xl border border-slate-200 shadow-sm space-y-6">
          <div className="flex items-center gap-3">
            <HelpCircle className="h-6 w-6 text-primary" />
            <h2 className="text-2xl font-bold text-slate-900">What is an ATS Resume Checker?</h2>
          </div>
          <div className="p-4 bg-primary-50/60 rounded-xl border border-primary-100 text-slate-800 text-sm leading-relaxed">
            <strong>Direct Answer:</strong> An ATS resume checker is an automated tool that parses your CV against corporate recruitment software criteria (such as Taleo, Workday, or Lever). It evaluates keyword match density, structural compliance, font readability, and STAR-metric accomplishments to predict whether your resume will pass initial employer screening.
          </div>
          
          <div className="space-y-4 pt-2">
            <h3 className="text-lg font-bold text-slate-900">Key Dimensions Evaluated by Sophi ATS Engine</h3>
            <ul className="grid sm:grid-cols-2 gap-3 text-sm text-slate-700">
              <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-emerald-600" /> Keyword Alignment & Hard Skills</li>
              <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-emerald-600" /> Single-Column Parsing Safety</li>
              <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-emerald-600" /> STAR Action Verb Intensity</li>
              <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-emerald-600" /> Executive Section Headings</li>
            </ul>
          </div>
        </section>
      </main>
