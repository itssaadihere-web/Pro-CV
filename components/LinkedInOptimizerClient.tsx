      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <section className="mt-16 bg-white p-8 rounded-2xl border border-slate-200 shadow-sm space-y-4">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-bold text-slate-900">How to Optimize LinkedIn Profile for Recruiters?</h2>
          </div>
          <div className="p-4 bg-blue-50/60 rounded-xl border border-blue-100 text-slate-800 text-sm leading-relaxed">
            <strong>Direct Answer:</strong> To rank high in recruiter search algorithms, your LinkedIn profile requires a keyword-loaded headline (Role + Target Skills + Value Proposition), a 3-line structural hook summary with STAR metrics, and endorsed skills matched to active employer job postings. Sophi LinkedIn Optimizer generates all three in under 30 seconds.
          </div>
        </section>
      </main>
    </div>
