...
import { Sparkles, ArrowRight, Eye, CheckCircle2, ShieldCheck, X, FileText } from 'lucide-react'
import { CVData } from '@/lib/cvParser'

// Import all 10 official SOPHI CV Templates
...
// Representative Sample Data for Live Template Rendering
...
// 10 Official SOPHI CV Templates Registry
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 relative">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16 space-y-12">
        ...
        {/* Templates Grid displaying LIVE React Component Previews */}
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {filteredTemplates.map((tmpl, index) => {
            ...
            return (
              ...
              >
                {/* Template Visual Preview Box — Renders real React template scaled down */}
        ...
        <div className="rounded-3xl bg-gradient-to-br from-primary-950 via-primary-900 to-slate-950 p-8 sm:p-12 text-white text-center space-y-6 shadow-2xl relative overflow-hidden">
          ...
          <p className="text-slate-300 text-sm max-w-xl mx-auto leading-relaxed">
            Create your CV once with <S>SOPHI</S> AI, and instantly switch between any of these 10 premium templates in 1 click.
          </p>
